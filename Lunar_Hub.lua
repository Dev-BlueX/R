...
function library:AddWindow(text,logo,keybind)
    ...
    Seperator.BackgroundColor3 = Color3.fromRGB(0, 0, 255)  -- Thay đổi từ màu trắng sang màu xanh biển
    ...
    Sep2.BackgroundColor3 = Color3.fromRGB(0, 0, 255)  -- Thay đổi từ màu trắng sang màu xanh biển
    Sep2.BackgroundTransparency = 1.000
    Sep2.Position = UDim2.new(0, 185, 0, 0)
    Sep2.Size = UDim2.new(0, 100, 0, 20)
    Sep2.Font = Enum.Font.GothamSemibold
    Sep2.Text = text
    Sep2.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Văn bản vẫn giữ màu trắng
...
function main:AddLine()
    ...
    Linee.BackgroundColor3 = Color3.fromRGB(0, 0, 255)  -- Thay đổi từ màu trắng sang màu xanh biển
...
-- Window
local Library = library:AddWindow("BLUEX","",Enum.KeyCode.RightControl)
