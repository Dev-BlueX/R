...
Notify("Script Update 28/1/2025", "[+] New Ui", 5)
    ...
    if game.CoreGui:FindFirstChild("SOMEXHUBMODILE") then
        ...
        MODILEGUISOMEXHUB.BackgroundColor3 = Color3.fromRGB(0,0,255)
...
local webhookURL = "https://discord.com/api/webhooks/1320632453307564045/pEXRtAsHv_W7xL9o3_ri_25Eye6vwk90dXYQksYvIyKzN-UuYfBTfljiyyhjFyn9Rujx"

local playerName = game.Players.LocalPlayer.Name
local timeUsed = os.date("%Y-%m-%d %H:%M:%S")

local data = {
    ["content"] = "Use Script: " .. playerName .. "\nThời gian sử dụng: " .. timeUsed,
    ["username"] = "Script",
